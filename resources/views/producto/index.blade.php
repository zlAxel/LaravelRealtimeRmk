        ...
        <div class="container mx-auto px-6">
            <div class="md:flex md:items-center">
                ...
                <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                    <h3 id="product" class="text-gray-700 uppercase text-lg">Nike Air</h3>
                    <span id="price" class="text-gray-500 mt-3">$125</span>
                    <hr class="my-3">
                    <div class="mt-2">
                        ...
                        <div class="flex items-center mt-1">
                            ...
                            <span id="amount" class="text-gray-700 text-lg mx-2">20</span>
                            <button class="text-gray-500 focus:outline-none focus:text-gray-600">
                    ...
                    <div class="flex items-center mt-6">
                        <button id="buy" class="px-8 py-2 bg-indigo-600 text-white text-sm font-medium rounded hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500">Order Now</button>
    ...
    <script>
        $(document).ready(function () {
            ...
            $($buy).click(function (e) { 
                ...
                // Enviamos petición con Axios
                axios.post('{{ route('producto.store') }}', {
